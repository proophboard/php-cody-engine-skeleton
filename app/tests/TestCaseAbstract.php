...
use Acme\ServiceFactory;
use AcmeTest\Mock\EventQueueMock;
use AcmeTest\Mock\MockContainer;
...
class TestCaseAbstract extends TestCase
{
    ...
    protected function setUpEventEngine(array $mocks = []): void
    {
        ...
        $this->eventQueue = new class ($this->eventEngine) implements MessageProducer, EventQueueMock {
            ...
            /**
             * @return mixed In case of a query a result is returned otherwise null
             */
            ...
            public function process(): void
            {
                ...
                foreach ($events as $event) {
                    $this->eventEngine->dispatch($event);
                }
            }
        };
    ...
    protected function assertRecordedEvent(string $eventName, array $payload, array $events, bool $assertNotRecorded = false): void
    {
        $isRecorded = false;
