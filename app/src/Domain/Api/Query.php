...
class Query implements EventEngineDescription
{
    ...
    public static function describe(EventEngine $eventEngine): void
    {
         ...
         *
         * @see \Acme\Domain\Api\Type for details
         * @see \Acme\Domain\Api\Schema for best practise of how to reuse return type schemas
         *
         * @example
         *
         ...
         *      ->setReturnType(Schema::user()); //<-- Pass type reference as return type, @see \Acme\Domain\Api\Schema::user() (in the comment) for details
         *
