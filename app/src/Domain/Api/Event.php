...
class Event implements EventEngineDescription
{
    ...
    public static function describe(EventEngine $eventEngine): void
    {
         ...
         *          Payload::USERNAME => Schema::username(), //<-- See Acme\Domain\Api\Payload for property constants ...
         *          Payload::EMAIL => Schema::email(), //<-- ... and Acme\Domain\Api\Schema for schema definitions
         *                                             // See also Acme\Domain\Api\Command, same schema definitions are used there
         *      ])
         * );
         */
    }
